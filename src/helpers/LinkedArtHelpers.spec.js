...
describe("get creators", () => {
  it("gets the creator", () => {
    let creators = helpers.getCreators(fables);
    let filtered = [];
    ...
    expect(filtered).toEqual([
      {
        id:
          "https://data.getty.edu/museum/collection/object/f8fd6961-6da3-4c39-94ad-e8e9367fa51b/production/1663467e-66d8-4170-91b0-2937ba6447e6/unknown-maker",
        label: "Unknown",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/4f6f0d33-2646-4410-93fa-d0ecadf8852a",
        label: "Aesop",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/d7433a2b-feae-4cb8-a5e0-ec14fe1ef308",
        label: "Pope Clement V",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/8bf6aab8-b8f6-416b-b924-7c0020a792f5",
        label: "Avianus",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/c60ea30a-5d9a-4128-abad-ff3714ab8bc5",
        label: "Richard Fitzralph",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/c98e9cea-c658-4a47-b054-df28d11471a1",
        label: "John Mandeville",
      },
      {
        id:
          "https://data.getty.edu/museum/collection/person/09a22d6e-a6bd-4f22-9062-814328759bee",
